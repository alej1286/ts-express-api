...
const createToDo = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var todos = yield todos_model_1.Todos.create(Object.assign({}, req.body));
    return res
        .status(200)
...
const deleteToDo = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const deletedTodo = yield todos_model_1.Todos.findByPk(id);
    yield todos_model_1.Todos.destroy({ where: { id } });
    return res
        .status(200)
...
const getAllToDo = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const allTodos = yield todos_model_1.Todos.findAll();
    return res
        .status(200)
...
const getTodoById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const todos = yield todos_model_1.Todos.findByPk(id);
    return res
        .status(200)
...
const updateTodo = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    yield todos_model_1.Todos.update(Object.assign({}, req.body), { where: { id } });
    const updatedTodos = yield todos_model_1.Todos.findByPk(id);
    return res
        .status(200)
